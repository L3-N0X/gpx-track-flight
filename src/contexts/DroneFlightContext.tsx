import { createContext, useContext, useRef, useState, useMemo, type MutableRefObject } from 'react';
...
export function DroneFlightProvider({ children }: { children: React.ReactNode }) {
...
export function useDroneFlight() {
  ...
  if (!context) {
    throw new Error('useDroneFlight must be used within a DroneFlightProvider');
  }
  return context;
}
