...
import { Play, Pause, RotateCcw, ChevronUp, Square, Settings } from 'lucide-react'
    ...
    return (
        <>
            ...
            <div className="absolute top-4 right-4 z-20 flex flex-col items-end pointer-events-auto">
                {isExpanded ? (
                    <div className="bg-background/75 backdrop-blur-md border border-border rounded-xl shadow-lg p-2 min-w-50 flex flex-col gap-3">
                        <div
                    ...
                    <button
                        ...
                        className="flex h-9 w-9 items-center justify-center rounded-lg border border-border bg-background/75 text-muted-foreground shadow-md backdrop-blur-sm transition-colors hover:text-foreground hover:bg-background"
