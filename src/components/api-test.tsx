...
export function ApiTest() {
    const [healthResponse, setHealthResponse] = useState<ApiResponse | null>(
        null
    )
    const [versionResponse, setVersionResponse] = useState<ApiResponse | null>(
        null
    )
    ...
    return (
        <Card className="w-full">
            <CardHeader>
                ...
                <CardDescription>
                    Test the available API endpoints to check server
                    connectivity
                </CardDescription>
            </CardHeader>
            <CardContent>
